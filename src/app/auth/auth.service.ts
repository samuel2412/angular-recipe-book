...
export class AuthService{
  ...
  autoLogin(){
    ...
    if(loadedUser.token){
      ...
      this.store.dispatch( new AuthActions.Login( { email: loadedUser.email, userId: loadedUser.id, token: loadedUser.token, expirationDate:  new Date(user._tokenExpirationDate)  } ) )
